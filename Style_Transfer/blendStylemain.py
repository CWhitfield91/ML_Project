...
style_img1 = image_loader("kandinsky2.jpg")
style_img2 = image_loader("picasso.jpg")
content_img = image_loader("dancing.jpg")

assert style_img1.size() == style_img2.size(), \
...
style1_layers_default = ['conv_1','conv_2','conv_3','conv_4','conv_5'] # ,'conv_2','conv_3','conv_4','conv_5'
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       ...
                       style1_weight=1000000, style2_weight=1000000, content_weight=3):
